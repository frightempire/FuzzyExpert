...
namespace FuzzyExpert.Core.InferenceEngine.Implementations
{
    ...
    {
        private readonly List<InferenceResult> _activationOrder = new List<InferenceResult>();
        ...
        public List<InferenceResult> GetInferenceResults(List<InitialData> initialData)
        {
