...
namespace FuzzyExpert.Infrastructure.UnitTests.ProductionRuleParsing.Implementations
{
    ...
    public class ImplicationRuleParserTests
    {
        ...
        {
            // Arrange
            string implicationRule = "Distance=7&(Enumeration=4|Kinetic=555)|Average=5|Business=10";
            List<string> expectedRuleParts = new List<string>
            {
        ...
        {
            // Arrange
            string statement = "Average<10";
            UnaryStatement expectedUnaryStatement = new UnaryStatement("Average", ComparisonOperation.Less, "10");
        ...
        public void ParseUnaryStatement_ReturnsStatementWithGreater()
        {
            // Arrange
            string statement = "Average>10";
            UnaryStatement expectedUnaryStatement = new UnaryStatement("Average", ComparisonOperation.Greater, "10");
        ...
        public void ParseUnaryStatement_ReturnsStatementWithLessOrEqual()
        {
            // Arrange
            string statement = "Average<=10";
            UnaryStatement expectedUnaryStatement = new UnaryStatement("Average", ComparisonOperation.LessOrEqual, "10");
        ...
        public void ParseUnaryStatement_ReturnsStatementWithGreaterOrEqual()
        {
            // Arrange
            string statement = "Average>=10";
            UnaryStatement expectedUnaryStatement = new UnaryStatement("Average", ComparisonOperation.GreaterOrEqual, "10");
        ...
        public void ParseUnaryStatement_ReturnsStatementWithEqual()
        {
            // Arrange
            string statement = "Average=10";
            UnaryStatement expectedUnaryStatement = new UnaryStatement("Average", ComparisonOperation.Equal, "10");
        ...
        public void ParseUnaryStatement_ReturnsStatementWithNotEqual()
        {
            // Arrange
            string statement = "Average!=10";
            UnaryStatement expectedUnaryStatement = new UnaryStatement("Average", ComparisonOperation.NotEqual, "10");
        ...
        [Test]
        public void ParseUnaryStatement_ThrowsArgumentExceptionIfItDoesNotContainAnyComparisonOperations()
        {
            // Arrange
            string statement = "Average";
